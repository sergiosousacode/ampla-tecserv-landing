  ...
  return (
    <section className="grid gap-6">
      <div className="rounded-[1.5rem] bg-white p-6 text-slate-900 ring-1 ring-slate-200 dark:bg-slate-950/60 dark:text-text dark:ring-white/10">
        ...
        <h2 className="mt-3 text-2xl font-bold">Base de empresas para ordens de servico</h2>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-700 dark:text-slate-300">
          ...
          aqui, ela ja fica disponivel para selecao no fluxo operacional.
        </p>
      </div>
      ...
      <div className="rounded-[1.5rem] bg-white p-6 text-slate-900 ring-1 ring-slate-200 dark:bg-slate-950/60 dark:text-text dark:ring-white/10">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-700 dark:text-slate-300">
          Use um cadastro leve no MVP. Depois podemos expandir para endereco,
          anexos, multiplos contatos e vinculo com usuarios cliente.
        </p>
