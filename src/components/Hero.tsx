...
export default function Hero() {
  return (
    <section className="">
        <div className="mx-auto py-25 text-center">
          <h3 className="text-white mb-6 text-2xl font-bold dark:text-text">
            SUPORTE E ASSESSORIA PARA EMPRESAS QUE NÃO PODEM PARAR.
          </h3>

          <p className="mb-8 leading-7 text-justify dark:text-text sm:text-lg">
